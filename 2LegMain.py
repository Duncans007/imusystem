...
#-----------------------------------------------------
        if teensySend:
            if addGravityToTorque:
                parent_conn_teensy.send([kneelingTorqueEstimationL + cuny_data["ActTqL"], kneelingTorqueEstimationR + cuny_data["ActTqR"]])
            else:
                parent_conn_teensy.send([kneelingTorqueEstimationL, kneelingTorqueEstimationR])
